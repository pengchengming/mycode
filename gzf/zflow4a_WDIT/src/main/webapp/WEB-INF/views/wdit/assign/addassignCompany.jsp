		...
		$.ajax({
	        ...
	        data : {
				...
				if(data.successMsg){
					...
					window.location.href="<c:url value='/assign/assigncompanylist' />";
		 		}else{
		 			alert("操作失败");
		 			layer.close(index);
		 			return false;
                ...
                <div class="container">
                    ...
                    <div class="row hidden-sm hidden-xs">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                <li>委办</li>
                                <li class="active"><a href="<c:url value="/assign/assigncompanylist" />">认证企业管理</a></li>
                               		...
                               		<div class="row">
                               			<div class="col-sm-6">
                               				<div class="form-group">
                               					...
                               					<div class="col-sm-9">
                               						<input id="registerMoney" onblur="moneyFun(this)" class="form-control" type="text" placeholder="必填">
                               					</div>
                               				</div>
                               			</div>
                               			<div class="col-sm-6">
                               		...
                               		<div class="row">
                               			<div class="col-sm-6">
                               				<div class="form-group">
                               					...
                               					<div class="col-sm-9">
                               						<input id="staffNum" class="form-control" type="text" placeholder="必填">
                               					</div>
                               				</div>
                               			</div>
                               			<div class="col-sm-6">
                               		...
                               		<div class="row">
                               			...
                               			<div class="col-sm-6">
                               				<div class="form-group">
                               					...
                               					<div class="col-sm-9">
                               						<input id="phone" class="form-control" type="text" placeholder="必填">
                               					</div>
                               				</div>
                               			</div>
                               		</div>

                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9" id="housingConditionsInTheCity_div"> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        	...
                                        	<div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <label style="margin-top: 7px;text-align: center" id="pickDwelling_Name"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" placeholder="毕业时间 请按1999-01-01格式填写" id="graduationTime_id" class="form-control" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <table id="userPhoto_table" class="table table-bordered table-hover text-center table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr id="maritalStatus_photo_tr">
                                                                <td>申请人婚姻情况证明<br>(结婚提供结婚证，离婚提供离婚证)</td>

 ...
 function uploadForm(id){
	 $("#"+id+"_form_id").ajaxForm({
			...
			success : function(json) {
				...
				if (data.code + "" == "1") {
					var str="<input type='hidden' value='"+data.imageName+"' /><input type='hidden' value='"+data.imagePath+"'/><input type='hidden' value='"+data.smallImagePath+"'/><img src='"+rootPath+data.smallImagePath+"'>&nbsp;<a href='javascript:void(0)' onclick='deletePhoto(\""+id+"\");'>删除</a>";
		        	$("#"+id+"_id").html(str);
				} else {
					alert("上传失败");
				}
		...
		$.ajax({
			...
			complete : function(xhr, textStatus){
				...
				if(results&&results.length>0){
					...
					var pickDwelling=company.pickDwelling;
					...
					if(companyPhotos&&companyPhotos.length>0){
						$.each(companyPhotos,function(i,companyPhoto){
							...
							var  licenseNumber=companyPhoto.licenseNumber;
							$("#licenseNumber_id").val(licenseNumber);
							if(photoType){
								 $(".radioTab>div").hide();
								$(".radioTab>div").eq(photoType-1).show();
								...
								if(photoType+""=="1"){
									...
									$("#licenseNumber_id").val(licenseNumber);
									if(businessLicense)
										$("#businessLicense_id").html('<input type="hidden" value="'+businessLicenseName+'" /><input type="hidden" value="'+businessLicense+'"/><input type="hidden" value="'+businessLicenseSmallPhoto+'"/> <img src="'+rootPath+businessLicenseSmallPhoto+'" height="180" alt=""><a href="javascript:void(0)" onclick="deletePhoto(\'businessLicense\');">删除</a>');									 
								}else {
...
function saveCompanyFun(){
	...
	if(photoType+""=="1"){ 
		...
		var businessLicenseInputs=$("#businessLicense2_id").find("input");
    	var organizationPhotoInputs=$("#organizationPhoto_id").find("input");
    	var taxationPhotoInputs=$("#taxationPhoto_id").find("input");//原错误
	...
	$.ajax({
		...
		type : "POST", 
      	...
      	data : {
			...
			if(data.successMsg)
		 		{
				window.location.href=rootPath+"company/mycompany?id="+data.id;
		 		}
		    }
      });
}
                ...
                <div class="container">
                    ...
                    <div class="row hidden-sm hidden-xs">
                        <div class="col-md-12">
                            <ol class="breadcrumb">
                                 <li>企业用户</li>
                                <li class="active"><a href="<c:url value="/company/mycompany?id=${sessionScope.USER.companyId}" />">我的申请</a></li>
                                <li class="active">更改单位信息</li>                           
                            </ol>
                        </div>
                    </div>
                    <!-- end: BREADCRUMB -->
                                ...
                                <div class="panel-body no-padding-top">
                                     	<div role="form" class="form-horizontal">
		                                        ...
		                                        <div class="row">
		                                        	<div class="col-sm-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <div class="col-sm-9">
		                                                        <input type="text" placeholder="必填" onblur="moneyFun(this)"  id="registerMoney_id" class="form-control">
		                                                    </div>
		                                                </div>
		                                            </div>
		                                            <div class="col-sm-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <div class="col-sm-9">
		                                                        <input type="text" placeholder="必填" onblur="moneyFun(this)" id="oneYearIsTaxAmount_id" class="form-control">
		                                                    </div>
		                                                </div>
		                                            </div>
		                                        </div>
		                                        <div class="row">
		                                            ...
		                                            <div class="col-sm-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <div class="col-sm-9">
		                                                        <select class="form-control"  id="rent_id">
		                                                        </select>
		                                                    </div>
		                                                </div>
		                                            </div>
		                                        ...
		                                        <div class="row">
		                                            <div class="col-sm-6">
		                                                <div class="form-group">
		                                                    ...
		                                                    <div class="col-sm-9">
		                                                        <select class="form-control"  id="pickDwelling_id">
		                                                        </select>
		                                                    </div>
		                                                </div>
		                                            </div>
		                                                        ...
		                                                        <table class="table table-bordered table-hover text-center table-striped">
		                                                            ...
		                                                            <tbody>
		                                                                <tr>
		                                                                    <td>营业执照或企业法人</td>
		                                                                    <td>
		                                                                        <p><span style="color:#FF0000;">*</span>证件编号：</p>
		                                        ...
		                                        <div class="text-center">
		                                            ...
		                                            <a class="btn btn-default" href="<c:url value="/company/mycompany"/>">关闭</a>
		                                        </div>
		                                    </div>
                                 </div>
                             </div>

...
$(function(){
	...
	$("#companytype").html("<option value=''>请选择</option>"+dictionaryValueHtml);
 	...
 	field.doRender = function(data, container, config, rowIndex){
 		...
 		$(a1).attr('href', rootPath + 'talentoffice/showcompany?id='+id).html('&nbsp;查看&nbsp;');
 		$(container).append(a1);
 		var a2 = document.createElement('a');
 		$(a2).attr('href', rootPath + 'talentoffice/updatecompany?id='+id+'&type='+1).html('&nbsp;修改&nbsp;');
 		$(container).append(a2);

...
<div class="index_banner">
	...
	<div class="index_menu"> 
		<a href="<c:url value="/procinstJbpm/ccmhome"/>"  class="ui-menu" style="float:left;padding:0 50px;margin-left:20px;line-height:40px;"><div class="ui-menu-text">My Calls</div></a>
		<a href="<c:url value="/procinstJbpm/ccmdeployStart?zflowCode=clientCall"/>"  class="ui-menu" style="float:left;padding:0 50px;margin-left:20px;line-height:40px;"><div class="ui-menu-text">Record New Call</div></a>
	</div>

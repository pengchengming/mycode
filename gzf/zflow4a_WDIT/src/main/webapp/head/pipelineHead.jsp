<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<div class="index_menu"> 
		<a href="<c:url value="/pipeline/list"/>"  class="ui-menu" style="float:left;padding:0 50px;margin-left:20px;line-height:40px;"><div class="ui-menu-text">Potential Leads</div></a>
		<a href="<c:url value="/pipeline/add"/>"  class="ui-menu" style="float:left;padding:0 50px;margin-left:20px;line-height:40px;"><div class="ui-menu-text">Add New</div></a>
	</div>

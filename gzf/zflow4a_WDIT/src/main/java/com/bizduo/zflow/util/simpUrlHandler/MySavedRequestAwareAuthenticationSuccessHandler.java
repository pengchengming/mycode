package com.bizduo.zflow.util.simpUrlHandler;
...
public class MySavedRequestAwareAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler{  
    ...
    public MySavedRequestAwareAuthenticationSuccessHandler(String defaultTargetUrl) {  
        setDefaultTargetUrl(defaultTargetUrl);
        LOCAL_SERVER_URL=defaultTargetUrl;
    } 

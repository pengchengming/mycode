...
@Entity
@Table(name="dm_biz_type")
public class BizType   implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4061483533230165145L;
	private Long id;
	private String code;//类型编号
	private String name;
	@Id //对应数据库中的主键  
    @GeneratedValue(strategy=GenerationType.TABLE,//指定主键生成策略  
                    generator="dm_biz_type")    //对应生成策略名称  
    @TableGenerator(name="dm_biz_type", //生成策略名称  
                    pkColumnName="sequence_name",     //主键的列名  
                    pkColumnValue="dm_biz_type",            //主键的值  

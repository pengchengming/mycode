...
/**
 * Servlet implementation class BizChatServlet
 */
public class BizChatServlet extends HttpServlet {
     ...
     */  
      private void  manageMessage(String requestStr,HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{  
            ...
            try {  
                 ...
                 if(jsonObject.has("Event")&&jsonObject.has("MsgType") ){
                	 String event =jsonObject.getString("Event");  
                     String msgtype =jsonObject.getString("MsgType");  
                     if("CLICK".equals(event) && "event".equals(msgtype)){ //菜单click事件  
                         String eventkey =jsonObject.getString("EventKey");  
                         if("V1001_GOOD".equals(eventkey)){ // hytd_001 这是好友团队按钮的标志值  

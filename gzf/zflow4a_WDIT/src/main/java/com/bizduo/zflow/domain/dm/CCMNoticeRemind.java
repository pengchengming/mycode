...
//@Entity
//@Table(name="ccm_notice_Remind")  
public class CCMNoticeRemind implements Serializable {
	...
	public CCMNoticeRemind() {
	} 
	public CCMNoticeRemind(Long id) {
		this.id = id;
	}

	public CCMNoticeRemind(Long taskId, User readUser, int userType, Long dataId,
